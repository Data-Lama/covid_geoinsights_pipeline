...
async def run_model_for_poly(df_mov_poly_id, df_cases_diag_id, p_delay):
    ...
    return (R0_dist.mean(), beta_dist.mean())


async def main():
    location_name = "colombia"
    agglomeration_folder = "geometry"
    ...
    for poly_id in df_mov_ranges.poly_id.unique():
        ...
        if all_cases_id > 100:
            ...
            r0_mean, beta_mean = await run_model_for_poly(df_mov_poly_id, df_cases_diag_id, p_delay)
            print(r0_mean)
            print(beta_mean)
