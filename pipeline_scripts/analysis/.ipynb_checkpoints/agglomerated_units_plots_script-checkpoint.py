...
for agglomeration_method in agglomeration_methods:
	...
	export_folder_location = os.path.join(data_dir, 'analysis', location_folder, agglomeration_method, 'agglomerated_polygons_plots')
	...
	df_plot['num_cases'] = df_plot['num_cases'].rolling(3, min_periods=1).mean()
