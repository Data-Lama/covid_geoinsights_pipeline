...
data_stages_location = Path(os.path.realpath(__file__)).parent.parent.parent
data_stages_location = os.path.join(data_stages_location, 'data/data_stages/')
